...
# 3. The data from each iteration is saved in JSON format in generation_mapping file created in the same folder, which was used for our comprehensive analysis. You can review this data for reference.
